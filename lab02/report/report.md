...
1. Написал функцию cipher_transposition для шифрования текста. (рис. -@fig:001) (рис. -@fig:002) (рис. -@fig:003)
...
![Функция для кодирования текста шифром Маршрутного шифрования](image/1.png){ #fig:001 width=70% }


![Блок кода для вывода результат в соответствии с шифром Маршрутного шифрования](image/2.png){ #fig:002 width=70% }


![Функция для определения индекс буквы в ключе](image/3.png){ #fig:003 width=70% }
...
Пополнял свободное место в матрице случайным образом из списки алфавита. (рис. -@fig:005)

![Блок кода для шифрования с помощью решеток](image/5.png){ #fig:005 width=70% }

Писал код для выполнения матрицы(рис. -@fig:006)

![Блок для выполнения матрицы](image/6.png){ #fig:006 width=70% }

Получил результат. (рис. -@fig:007)

![Получение шифрования текста методом решётки](image/7.png){ #fig:007 width=70% }

3. Написал функцию vingere для шифрования Виженера. (рис. -@fig:008)
...
![Функция для кодирования текста шифром Фиженера](image/8.png){ #fig:008 width=70% }

Получил результат. (рис. -@fig:009)
